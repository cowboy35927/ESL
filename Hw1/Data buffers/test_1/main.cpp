...
int sc_main(int argc, char **argv) {
  ...
  Testbench tb("tb");
  Median_MeanFilter median_meanFilter("median_meanFilter");
  ...
  tb.i_clk(clk);
  tb.o_rst(rst);
  median_meanFilter.i_clk(clk);
  median_meanFilter.i_rst(rst);
  tb.o_r(r);
  tb.o_g(g);
  tb.o_b(b);
  ...
  median_meanFilter.i_r(r);
  median_meanFilter.i_g(g);
  median_meanFilter.i_b(b);
  median_meanFilter.o_result_r(result_r);
  median_meanFilter.o_result_g(result_g);
  median_meanFilter.o_result_b(result_b);
