...
void Median_MeanFilter::do_filter() {  
  ...
  while (true) {
    ...
    if (i == 13)
    {
      ...
      //cout << "Now at " << sc_time_stamp() << "CCCC454156165 R: "<< int(mid_r)<<",delay:"<<delay<< endl; // print current sc_time
      //cout << "Now at " << sc_time_stamp() << "CCCC454156165 G: "<< int(mid_g)<<",delay:"<<delay<< endl; // print current sc_time
      //cout << "Now at " << sc_time_stamp() << "CCCC454156165 B: "<< int(mid_b)<<",delay:"<<delay<< endl; // print current sc_time  
      //m_qk.inc( delay );
      // Check if synchronize is necessary
      //if (m_qk.need_sync()) m_qk.sync();
      // cout << "Now at " << sc_time_stamp() << " MEAN " << endl; // print current sc_time   
