...
// Generated on: May 26 2023 06:00:55 CST (May 25 2023 22:00:55 UTC)

module SobelFilter_N_Mux_20_4_9_4(in5, in4, in3, in2, ctrl1, out1);
  ...
  AOI22X1 g357(.A0 (in3[5]), .A1 (n_28), .B0 (in4[5]), .B1 (n_49), .Y
       (n_8));
  INVX1 g367(.A (n_49), .Y (n_7));
  INVX1 g369(.A (n_28), .Y (n_6));
  AND3XL g370(.A (n_4), .B (ctrl1[2]), .C (n_2), .Y (n_28));
  AND4X1 g371(.A (ctrl1[1]), .B (n_0), .C (ctrl1[0]), .D (n_1), .Y
       (n_46));
  NOR2X1 g368(.A (n_3), .B (n_5), .Y (n_49));
  NAND3BXL g372(.AN (ctrl1[3]), .B (ctrl1[0]), .C (ctrl1[4]), .Y (n_5));
  NOR3BXL g373(.AN (ctrl1[3]), .B (ctrl1[0]), .C (ctrl1[4]), .Y (n_4));
  NAND2X1 g375(.A (ctrl1[2]), .B (n_2), .Y (n_3));
  NOR2X1 g374(.A (ctrl1[4]), .B (ctrl1[3]), .Y (n_1));
  INVX1 g377(.A (ctrl1[1]), .Y (n_2));
  INVX1 g376(.A (ctrl1[2]), .Y (n_0));
endmodule
