...
SobelFilter_ROM_9X32_sharpening::SobelFilter_ROM_9X32_sharpening(sc_module_name name) : sc_module(name) 
    ...
    ,sharpening()
{
  HLS_INITIALIZE_ROM( sc_uint<32> , sharpening, HLS::HLS_HEX, "bdw_work/modules/SobelFilter/PIPELINE/SobelFilter_ROM_9X32_sharpening_0.memh", "initialize SobelFilter_ROM_9X32_sharpening" ); 
