...
// Generated on: May 26 2023 05:59:06 CST (May 25 2023 21:59:06 UTC)

module SobelFilter_N_Mux_32_3_96_4(in4, in3, in2, ctrl1, out1);
  input [31:0] in4;
  input [8:0] in3, in2;
  input [5:0] ctrl1;
  output [31:0] out1;
  ...
  NAND4XL g2848(.A (n_8), .B (n_28), .C (n_16), .D (n_12), .Y (n_71));
  ...
  NOR4X1 g2859(.A (n_14), .B (n_10), .C (n_11), .D (n_15), .Y (n_17));
  NAND3BX1 g2861(.AN (ctrl1[1]), .B (n_5), .C (ctrl1[0]), .Y (n_25));
  NOR3X1 g2863(.A (n_15), .B (n_3), .C (n_13), .Y (n_16));
  NOR3X1 g2860(.A (n_6), .B (ctrl1[1]), .C (ctrl1[0]), .Y (n_36));
  ...
  NOR2BX1 g2874(.AN (ctrl1[0]), .B (ctrl1[5]), .Y (n_37));
  NOR2X1 g2876(.A (ctrl1[5]), .B (ctrl1[4]), .Y (n_11));
  NOR2X1 g2877(.A (ctrl1[4]), .B (ctrl1[0]), .Y (n_10));
  NOR2BX1 g2878(.AN (ctrl1[1]), .B (ctrl1[4]), .Y (n_7));
